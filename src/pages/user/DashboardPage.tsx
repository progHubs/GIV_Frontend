      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Here's an overview of your activity and impact with GIV Society.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="p-6">
              <div className="space-y-4">
                {[1, 2, 3].map((donation) => (
                  <div key={donation} className="flex items-center justify-between py-3 border-b border-gray-100 last:border-b-0">
                    <div>
                      <p className="font-medium text-gray-900">School Supplies Campaign</p>
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="p-6">
              <div className="space-y-4">
                {[1, 2, 3].map((event) => (
                  <div key={event} className="flex items-center justify-between py-3 border-b border-gray-100 last:border-b-0">
                    <div>
                      <p className="font-medium text-gray-900">Community Clean-up Drive</p>
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <p className="text-sm font-medium text-gray-900">Make Donation</p>
            </button>
            ...
            <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <p className="text-sm font-medium text-gray-900">Find Events</p>
            </button>
